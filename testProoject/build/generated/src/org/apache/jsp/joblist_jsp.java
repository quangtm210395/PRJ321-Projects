...
public final class joblist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    String tmpQuery = "WITH T AS (SELECT *,ROW_NUMBER() OVER (ORDER BY title ASC) AS SNO FROM InOrderJob WHERE tag LIKE '%" + tags + "%' AND category LIKE '%" + category + "%'" + ") SELECT MAX(SNO) FROM T";
    ...
    tmpQuery = "WITH T AS (SELECT *,ROW_NUMBER() OVER (ORDER BY title ASC) AS SNO FROM InOrderJob WHERE category LIKE '%Web Applications%') SELECT MAX(SNO) FROM T";
    db = new DbContext();
    try {
        ResultSet rs = db.executeQuery(tmpQuery);
    ...
    String query = "WITH T AS (SELECT *,ROW_NUMBER() OVER (ORDER BY title ASC) AS SNO FROM InOrderJob WHERE tag LIKE '%" + tags + "%' AND category LIKE '%" + category + "%'" + ") SELECT * FROM T WHERE SNO = ";
    ...
    int now = (max - count) > 10 ? 10 : (max - count + 1);
      ...
      out.write("\n");
      out.write("                    <h4 class=\"search-result-text\">Showing ");
      out.print(max);
      out.write(" of ");
      out.print(max);
      out.write(" available job(s)</h4>\n");
      out.write("                    ");
      ...
      out.write("                </div>\n");
      out.write("                <div class=\"col-md-8 col-sm-12 col-xs-12\">\n");
      out.write("                    <div class=\"all-jobs-list-box\">\n");
      out.write("                        ");
      ...
      out.write("                                </div>\n");
      out.write("                            </div>\n");
      out.write("                            <div class=\"col-md-6 col-sm-6 col-xs-12 nopadding\">\n");
      out.write("                                <div class=\"job-title-box\">\n");
      out.write("                                    <a href=\"#\">\n");
      out.write("                                        <div class=\"job-title\">");
      out.print(title);
      out.write("</div>\n");
      out.write("                                    </a>\n");
      out.write("                                    <a href=\"#\"><span class=\"comp-name\">");
      out.print(detail);
      out.write("</span></a>\n");
      out.write("                                </div>\n");
      out.write("                            </div>\n");
      ...
      out.write("                                <a href=\"#\">\n");
      out.write("                                    <div class=\"job-type jt-remote-color\">\n");
      ...
      out.write("                            <div class=\"col-md-2 col-sm-3 col-xs-6\">\n");
      out.write("                                <a href=\"#\">\n");
      out.write("                                    <div class=\"job-type jt-full-time-color\">\n");
      ...
      out.write("                            <div class=\"col-md-2 col-sm-3 col-xs-6\">\n");
      out.write("                                <a href=\"#\">\n");
      out.write("                                    <div class=\"job-type jt-part-time-color\">\n");
      ...
      out.write("                            <div class=\"col-md-2 col-sm-3 col-xs-6\">\n");
      out.write("                                <a href=\"#\">\n");
      out.write("                                    <div class=\"job-type jt-intern-color\">\n");
      out.write("                                        <i class=\"fa fa-clock-o\"></i> Freelancer\n");
      out.write("                                    </div>\n");
      out.write("                                </a>\n");
      out.write("                            </div>\n");
      out.write("\n");
      ...
      out.write("\n");
      out.write("                            <div class=\"col-md-2 col-sm-2 col-xs-12 nopadding\">\n");
      out.write("                                <button class=\"btn btn-primary btn-custom\">Apply Now</button>\n");
      out.write("                            </div>\n");
      out.write("                        </div>\n");
      out.write("\n");
      out.write("                        ");
      ...
      out.write("\n");
      out.write("\n");
      out.write("                                <li class=\"active\"><a href=\"joblist.jsp?tags=");
      out.print(tags);
      out.write("&category=");
      out.print(category);
      out.write("&count=");
      ...
      out.write("\n");
      out.write("                                <li><a href=\"joblist.jsp?tags=");
      out.print(tags);
      out.write("&category=");
      out.print(category);
      out.write("&count=");
      ...
      out.write("                            <div class=\"widget-heading\"><span class=\"title\">Hot Categories</span></div>\n");
      out.write("                            <ul class=\"categories-module\">\n");
      out.write("                                <li> <a href=\"\"> Web Applications <span>(");
      out.print(countWeb);
      out.write(")</span> </a> </li>\n");
      out.write("                                <li> <a href=\"\"> Desktop Applications <span>(");
      out.print(countDesktop);
      out.write(")</span> </a> </li>\n");
      out.write("                                <li> <a href=\"\"> Mobile Applications<span>(");
      out.print(countMobile);
      out.write(")</span> </a> </li>\n");
      out.write("                            </ul>\n");
      out.write("                        </div>\n");
      out.write("                        <div class=\"widget\">\n");
      out.write("                            <div class=\"widget-heading\"><span class=\"title\">Hot Jobs</span></div>\n");
      out.write("                            <ul class=\"related-post\">\n");
      out.write("                                <li>\n");
      out.write("                                    <a href=\"#\">Assistant Manager Procurement </a>\n");
      out.write("                                    <span><i class=\"fa fa-map-marker\"></i>Managgo, WC </span>\n");
      out.write("                                    <span><i class=\"fa fa-calendar\"></i>March 22, 2015 - Apr 07, 2016 </span>\n");
      out.write("                                </li>\n");
      out.write("                                <li>\n");
      out.write("                                    <a href=\"#\">Marketing Professionals Required</a>\n");
      out.write("                                    <span><i class=\"fa fa-map-marker\"></i>Homelando, New Vage </span>\n");
      out.write("                                    <span><i class=\"fa fa-calendar\"></i>Sep 01, 2015 - Aug 09, 2016</span>\n");
      out.write("                                </li>\n");
      out.write("                                <li>\n");
      out.write("                                    <a href=\"#\">Mobile App Programmers </a>\n");
      out.write("                                    <span><i class=\"fa fa-map-marker\"></i>Homelando, New Vage </span>\n");
      out.write("                                    <span><i class=\"fa fa-calendar\"></i>Feb 01, 2015 - March 09, 2016 </span>\n");
      out.write("                                </li>\n");
      out.write("                                <li>\n");
      out.write("                                    <a href=\"#\">General Compliance Officer</a>\n");
      out.write("                                    <span><i class=\"fa fa-map-marker\"></i>Arlington, VA </span>\n");
      out.write("                                    <span><i class=\"fa fa-calendar\"></i>Jun 01, 2015 - Feb 09, 2016</span>\n");
      out.write("                                </li>\n");
      out.write("                                <li>\n");
      out.write("                                    <a href=\"#\">Call Centre Manager</a>\n");
      out.write("                                    <span><i class=\"fa fa-map-marker\"></i>Managgo, WC  </span>\n");
      out.write("                                    <span><i class=\"fa fa-calendar\"></i>Feb 01, 2015 - March 09, 2016</span>\n");
      out.write("                                </li>\n");
      out.write("                                <li>\n");
      out.write("                                    <a href=\"#\">Assistant Manager Audit</a>\n");
      out.write("                                    <span><i class=\"fa fa-map-marker\"></i>Heling, WC </span>\n");
      out.write("                                    <span><i class=\"fa fa-calendar\"></i>Aug 01, 2015 - Sep 09, 2016 </span>\n");
      out.write("                                </li>\n");
      out.write("                                <li>\n");
      out.write("                                    <a href=\"#\">Telesales Agent (UK Dialing)</a>\n");
      out.write("                                    <span><i class=\"fa fa-map-marker\"></i>Somro, New </span>\n");
      out.write("                                    <span><i class=\"fa fa-calendar\"></i>Sep 01, 2015 - Nov 09, 2016</span>\n");
      out.write("                                </li>\n");
      out.write("                                <li>\n");
      out.write("                                    <a href=\"#\">Assistant Brand Manager</a>\n");
      out.write("                                    <span><i class=\"fa fa-map-marker\"></i>Heritage, VA </span>\n");
      out.write("                                    <span><i class=\"fa fa-calendar\"></i>Dec 01, 2015 - May 09, 2016</span>\n");
      out.write("                                </li>\n");
      out.write("                            </ul>\n");
      out.write("                        </div>\n");
      out.write("\n");

                    ...
                    <div class="profile-nav">
                        <div class="panel">
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li>
                                    <a href="userSavedCV.jsp"> <i class="fa fa-file-o"></i>Saved Resume </a>
                                </li>
                                <li class="active">
                        ...
                        <div class="job-box job-box-2">
                            ...
                            <div class="col-md-10 col-sm-10 col-xs-12">
                                <div class="job-title-box">
                                    <a href="jobDetail.jsp?jobid=<%=jobID%>">
                                        <div class="job-title"><%=title%></div>
                                    </a>
                                    <a href="#"><span class="comp-name"><%=detail%></span></a>
                                    ...
                                    %>
                                    <a href="" class="job-type jt-intern-color">

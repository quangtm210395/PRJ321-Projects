...
//    }
    ...
    try {
        ResultSet r = db.executeQuery("SELECT COUNT(*) AS rowcount FROM Posts");
        r.next();
        int size = r.getInt("rowcount");
        r.close();
        int pageCount = size / 5 + 1;
        String p = (String) session.getAttribute("pagi");
        int pagi = p != null ? Integer.parseInt(p) - 1 : 0;
        rs = db.executeQuery(sql);
        for (int i = 0 + 5 * pagi; i < 5 * pagi; i++) {
            if (rs.next()) {
      ...
      out.write("        <ul class=\"pagination\" id=\"pagination-buttons\">\n");
      out.write("            <li><a href=\"index.jsp?pagi=1\" class=\"selected-button\">1</a></li>\n");
      out.write("            <li><a href=\"index.jsp?pagi=1\">2</a></li>\n");
      out.write("            <li><a href=\"index.jsp?pagi=1\">3</a></li>\n");
      out.write("            <li><a href=\"index.jsp?pagi=1\">4</a></li>\n");
      out.write("        </ul>\n");
      out.write("\n");
      out.write("    </div>\n");
      out.write("</div>");

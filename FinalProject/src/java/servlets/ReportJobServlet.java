 ...
 * @author WindyKiss
 */
public class ReportJobServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                query = "SELECT * FROM Notification WHERE message LIKE '" + jobName + " Got Reported'";
                ...
                if (canReport) {
                    ...
                    preparedStatement.setString(3, jobName + " Got Reported");
                    preparedStatement.setString(4, "DetailReportServlet?jobID=" + jobID+"&canReport=1");

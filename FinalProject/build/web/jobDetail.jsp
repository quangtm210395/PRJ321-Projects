<%-- 
    Document   : jobDetail
    Created on : Dec 5, 2016, 1:17:55 PM
    Author     : WindyKiss
--%>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            ...
                            <aside>
                                <%
                                    if(canApply.equalsIgnoreCase("1")){
                                        
                                %>
                                <div class="apply-job">
                                    <a class="btn btn-default" href="AddOfferListServlet?jobID=<%=jobID%>"><i class="fa fa-upload"></i>Apply For Position</a>
                                </div>
                                
                                <div class="apply-job">
                                    <a class="btn btn-default" href="ReportJobServlet?jobID=<%=jobID%>"><i class="fa fa-recycle"></i>Report</a>
                                </div>
                                <%
                                    }
                                %>

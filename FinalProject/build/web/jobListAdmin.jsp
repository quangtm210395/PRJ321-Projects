<%-- 
    Document   : jobListAdmin
    Created on : Dec 7, 2016, 11:51:23 PM
    Author     : WindyKiss
--%>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="all-jobs-list-box2">
                        ...
                        <div class="job-box job-box-2">
                            <div class="col-md-2 col-sm-2 col-xs-12 hidden-sm hidden-xs">
                                <div class="comp-logo">
                                    <a href="jobReportDetail.jsp?jobid=<%=jobID%>&canReport=1"><img src="images/company/5.png" class="img-responsive" alt="scriptsbundle"> </a>
                                </div>

                            </div>
                            <div class="col-md-10 col-sm-10 col-xs-12">
                                <div class="job-title-box">
                                    <a href="jobReportDetail.jsp?jobid=<%=jobID%>&canReport=1">
                                ...
                                <p><a href="jobReportDetail.jsp?jobid=<%=jobID%>&canReport=1">Read More</a> </p>
                            </div>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                        <div class="pagination-box clearfix">
                            <ul class="pagination">
                                <li>
                                    <a href="jobListAdmin.jsp?loctaion=<%=loctaion%>&category=<%=category%>&jobType=<%=jobType%>&experience=<%=experience%>&salary=<%=salary%>&count=<%=(count - 10)%>" aria-label="Previous"> <span aria-hidden="true">«</span> </a>
                                </li>
                                <%
                                ...
                                <li class="active"><a href="jobListAdmin.jsp?loctaion=<%=loctaion%>&category=<%=category%>&jobType=<%=jobType%>&experience=<%=experience%>&salary=<%=salary%>&count=<%=(i * 10 - 9)%>"><%=i%></a></li>
                                    <%
                                    } else {
                                    %>
                                <li><a href="jobListAdmin.jsp?loctaion=<%=loctaion%>&category=<%=category%>&jobType=<%=jobType%>&experience=<%=experience%>&salary=<%=salary%>&count=<%=(i * 10 - 9)%>"><%=i%></a></li>
                                    <%
                                            }
                                        }
                                    %>
                                <li>
                                    <a href="jobListAdmin.jsp?loctaion=<%=loctaion%>&category=<%=category%>&jobType=<%=jobType%>&experience=<%=experience%>&salary=<%=salary%>&count=<%=(count + 10)%>" aria-label="Next"> <span aria-hidden="true">»</span> </a>
                                </li>
                            </ul>
                        </div>
                    </div>
